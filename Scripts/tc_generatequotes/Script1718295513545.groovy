...
if ((testType == 'Positive') && (expectedResult == 'Valid')) {
    ...
    Mobile.waitForElementPresent(findTestObject('Generate Quotes/descResultQuotes'), 10)

    Mobile.verifyElementVisible(findTestObject('Generate Quotes/descResultQuotes'), 10)
